...
msg = f"""
**⚡ ʟɛɢɛռɖaʀʏ ᴀғ ∂αякɮօt ⚡**
  •        [📑 Repo 📑](https://github.com/DARKBOTZ-OS/darkbot)
  •        [🚀 Deploy 🚀](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FDARKBOTZ-OS%2Fdarkbot&template=https%3A%2F%2Fgithub.com%2Fthe-darkbot%2Fdarkbot)
  •  ©️ {dark_channel} ™
"""
botname = Config.BOT_USERNAME

@dark_cmd(pattern="repo$")
