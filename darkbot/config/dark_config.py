# IF YOU ARE HOSTING DARKBOT ON OTHER VPS OR LOCALLY RATHER THAN HEROKU
...
class Config(object):
    ...
    BIO_MSG = os.environ.get("BIO_MSG", "∂αякbot")
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "itz_dark_userbot")
    MY_GROUP = os.environ.get("YOUR_GROUP", "DarkBot_Support")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://telegra.ph/file/fd93f6309369694e71644.jpg")
    ...
    TZ = os.environ.get("TZ", "Asia/Kolkata"Z
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/DARKBOTZ-OS/DarkBot")
